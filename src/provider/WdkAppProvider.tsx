...
import type { WdkConfigs, BundleConfig, DefaultWdkConfig } from '../types'
 ...
 * Provider props
 */
export interface WdkAppProviderProps<TConfig extends DefaultWdkConfig = DefaultWdkConfig> {
  /**
  ...
  networkConfigs: WdkConfigs<TConfig>
...
export function WdkAppProvider<TConfig extends DefaultWdkConfig = DefaultWdkConfig>({
  bundle: bundleConfig,
  networkConfigs,
